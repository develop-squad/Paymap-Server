    ...
    public class CrawlManager
    {
        ...
        private static void CrawlZeroPay()
        {
            ...
            while (true)
            {
                ...
                string requestURL = $"https://www.zeropay.or.kr/intro/frncSrchList_json.do?firstIndex={pointerIndex}&lastIndex={pointerIndex+9}&searchCondition=&tryCode={FilterSiDo:00}&skkCode={FilterSiGunGu:00}";
